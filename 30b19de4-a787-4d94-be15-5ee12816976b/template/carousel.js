...
var Carousel = function($element) {
  ...
  var left = 0,
  	right = 0,
    owl,
    $cursor = $('<div class="cursor cursor--fold"></div>'),
    $window = $(window),
    selectors = {
  ...
  var _mousemove = function(e) {
    ...
    var x = e.pageX - (cursorWidth/2) - 10,
        y = e.pageY - $window.scrollTop() - (cursorHeight/2),
    ...
    if (x > right) {
      $cursor.addClass('cursor--backwards')
    } else {
      $cursor.removeClass('cursor--backwards')
    }   
